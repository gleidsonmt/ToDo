...
public class I18n {
    ...
    public static List<Locale> getSupportedLocales() {
        return new ArrayList<>(Arrays.asList(Locale.of("en", "US"), Locale.of("pt", "BR"), Locale.of("es", "ES")));
    }
     ...
     * to MessageFormat.format, passing in the optional args and returning the
     * result.
     *
    ...
    public static String get(final String key, final Object... args) {
        ResourceBundle bundle = ResourceBundle.getBundle("io.github.gleidsonmt.todo.i18n.Lang", getLocale());
